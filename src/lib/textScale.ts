...
export const TEXT_SCALE = {
  ...
  overline:    { slug: 'overline',       size: 'var(--text-lg)',  leading: 'calc(var(--spacing) * 5)',   leadingComment: 'leading-5',    element: 'p',    className: 'font-ui font-bold uppercase' },
  // micro overline — section labels, metadata keys, category tags
  eyebrow:     { slug: 'eyebrow',        size: '10px',            leading: 'var(--leading-normal)',      leadingComment: '',             element: 'span', className: 'font-ui font-bold uppercase tracking-widest' },
